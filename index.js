...
function setTime() {
    ...
    var timeSelect = document.getElementById('timeSelect4').value;
    var hour = new Date().getHours();

    if (timeSelect == hour) {
        document.getElementById('image').style.backgroundImage = "url(./GoodNight.png)";
        document.getElementById('message').style.visibility = "visible";
        ...
        document.getElementById('message').style.top = "252px";
        document.getElementById('ge').innerHTML = "GOOD NIGHT !!";
        document.getElementById('ge').style.width = "482px";
        document.getElementById('timeList4').style.color="white"
    }


    var invalue = document.getElementById('timeSelect4');
    var value = invalue.options[invalue.selectedIndex].text;
    document.getElementById('timeList4').innerHTML = "Night Time: " + value;
